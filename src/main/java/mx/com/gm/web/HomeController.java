...
public class HomeController {
	...
	@Autowired
	private AreaService serviceCategorias;
	
	// Inyectamos una instancia desde nuestro ApplicationContext
    @Autowired
	private OfertaService serviceVacantes;
...
*/	
    ...
    /*
	@PostMapping("/signup")
	public String guardarRegistro( RedirectAttributes attributes) //Usuario usuario,
        {
...
//	}
	 ...
	 */
//	@GetMapping("/search")
//	public String buscar(@ModelAttribute("search") Oferta vacante, Model model) {
//		
//		/**
...
//		
//		Example<Oferta> example = Example.of(vacante, matcher);
//		List<Oferta> lista = serviceVacantes.buscarByExample(example);
